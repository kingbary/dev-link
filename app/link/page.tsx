...
export default function Link() {
    return (
        <DashboardLayout>
            <div>
                <div className='w-full flex flex-col gap-6 p-10 max-h-[150vh] overflow-y-scroll scrollbar-hide'>
                    <div className='mb-10'>
                        <h2 className='text-[32px] text-primary font-bold'>Customize your links</h2>
                        <p>Add/edit/remove links below and then share all your profiles with the world!</p>
                    </div>
                    <Button variant={"outline"}>+ Add new link</Button>
                    <div className='bg-lightGray p-5 rounded-xl flex flex-col items-center justify-center'>
                        <div className='flex flex-col items-center p-10'>
                            <Image src={"/assets/icons/illustration.svg"} width={249} height={160} alt='' />
                            <h2 className='text-[32px] text-primary font-bold mt-10 mb-6'>Let’s get you started</h2>
